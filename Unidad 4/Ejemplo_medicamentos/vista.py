...
class VentanaPrincipal(QMainWindow):
    def __init__(self): #Constructor de la clase
        ...
        loadUi(r'C:\Users\Pablo\Informática ll\git.repositorio\Inform-tica-ll\Unidad 4\Ejemplo_medicamentos\Ventana_ppal.ui',self)
...
class VentanaIngreso(QDialog):
    def __init__(self, ppal=None):
        super().__init__(ppal)
        loadUi(r'C:\Users\Pablo\Informática ll\git.repositorio\Inform-tica-ll\Unidad 4\Ejemplo_medicamentos\Ventana_Ingreso.ui',self)
...
class VentanaDroga (QDialog):
    def __init__(self,ppal=None):
        super().__init__(ppal)
        loadUi(r"C:\Users\Pablo\Informática ll\git.repositorio\Inform-tica-ll\Unidad 4\Ejemplo_medicamentos\Ventana_Droga.ui",self)
        self.__ListaDroga = {}
        self.__ventanaPadre = ppal
        self.setup()
    def setup(self):
